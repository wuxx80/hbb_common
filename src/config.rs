...
lazy_static::lazy_static! {
    ...
    // Display name for shortcuts and UI (can be Chinese)
    pub static ref APP_DISPLAY_NAME: RwLock<String> = RwLock::new("RustDesk".to_owned());
...
pub const LINK_DOCS_HOME: &str = "https://www.jrhskj.top/docs/en/";
pub const LINK_DOCS_X11_REQUIRED: &str = "https://www.jrhskj.top/docs/en/manual/linux/#x11-required";
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["118.24.164.85"];
pub const RS_PUB_KEY: &str = "7b5XtUT+PJErM75rbvrIRDHiJSj+sU+DVqF3AU7v8ZE=";
